...
/***/ function(module, exports, __webpack_require__) {
	...
	var when = __webpack_require__(157);
	var client = __webpack_require__(177);
	
	var follow = __webpack_require__(205); // function to hop multiple links by "rel"
	
	var stompClient = __webpack_require__(206);
		...
		_createClass(App, [{
			...
			value: function loadFromServer(pageSize) {
				...
				follow(client, root, [{ rel: 'employees', params: { size: pageSize } }]).then(function (employeeCollection) {
					...
					_this.setState({
						page: _this.page,
						employees: employees,
						attributes: Object.keys(_this.schema.properties),
						pageSize: pageSize,
						links: _this.links
					});
				});
			...
			value: function refreshCurrentPage(message) {
				...
				follow(client, root, [{
					...
					_this4.page = employeeCollection.entity.page;
	...
	var CreateDialog = (function (_React$Component2) {
		...
		function CreateDialog(props) {
			...
			_get(Object.getPrototypeOf(CreateDialog.prototype), 'constructor', this).call(this, props);
		...
		_createClass(CreateDialog, [{
			...
			value: function handleSubmit(e) {
				...
				this.props.attributes.forEach(function (attribute) {
					newEmployee[attribute] = React.findDOMNode(_this5.refs[attribute]).value.trim();
				});
				this.props.onCreate(newEmployee);
				this.props.attributes.forEach(function (attribute) {
					React.findDOMNode(_this5.refs[attribute]).value = ''; // clear out the dialog's inputs
				});
				window.location = "#";
			}
		}, {
	...
	var UpdateDialog = (function (_React$Component3) {
		...
		function UpdateDialog(props) {
			...
			_get(Object.getPrototypeOf(UpdateDialog.prototype), 'constructor', this).call(this, props);
			this.handleSubmit = this.handleSubmit.bind(this);
		}
		...
		_createClass(UpdateDialog, [{
			...
			value: function handleSubmit(e) {
				...
				var updatedEmployee = {};
				this.props.attributes.forEach(function (attribute) {
					updatedEmployee[attribute] = React.findDOMNode(_this6.refs[attribute]).value.trim();
				});
			...
			value: function render() {
				...
				var inputs = this.props.attributes.map(function (attribute) {
					return React.createElement(
						'p',
						{ key: _this7.props.employee.entity[attribute] },
						React.createElement('input', { type: 'text', placeholder: attribute,
							defaultValue: _this7.props.employee.entity[attribute],
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
		...
		var timed = __webpack_require__(158);
		var array = __webpack_require__(163);
		var flow = __webpack_require__(166);
		var fold = __webpack_require__(167);
		var inspect = __webpack_require__(168);
		var generate = __webpack_require__(169);
		var progress = __webpack_require__(170);
		var withThis = __webpack_require__(171);
		var unhandledRejection = __webpack_require__(172);
		var TimeoutError = __webpack_require__(162);
		...
		var apply = __webpack_require__(165)(Promise);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require) {
		...
		var env = __webpack_require__(159);
		var TimeoutError = __webpack_require__(162);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require) {
		...
		var state = __webpack_require__(164);
		var applier = __webpack_require__(165);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require) {
		...
		var inspect = __webpack_require__(164).inspect;
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function(require) {
		...
		var setTimer = __webpack_require__(159).setTimer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
		...
		var makePromise = __webpack_require__(175);
		var Scheduler = __webpack_require__(176);
		var async = __webpack_require__(159).asap;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var rest = __webpack_require__(178);
	var defaultRequest = __webpack_require__(186);
	var mime = __webpack_require__(188);
	var uriTemplateInterceptor = __webpack_require__(202);
	var errorCode = __webpack_require__(203);
	...
	(function (define) {
		...
		!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
			...
			var rest = __webpack_require__(179),
			    browser = __webpack_require__(181);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (define) {
		...
		!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
			...
			client = __webpack_require__(180);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (define) {
		...
		!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
			...
			defaultClient = __webpack_require__(179);
			mixin = __webpack_require__(183);
			responsePromise = __webpack_require__(185);
			client = __webpack_require__(180);
			when = __webpack_require__(157);
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(__WEBPACK_AMD_DEFINE_RESULT__ = function (require) {
		...
		var interceptor = __webpack_require__(187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SockJS = __webpack_require__(207); // <1>
	__webpack_require__(271); // <2>
...
/***/ function(module, exports, __webpack_require__) {
	...
	, __webpack_require__(240)(__webpack_require__(248))
	, __webpack_require__(250)
	, __webpack_require__(251)
	, __webpack_require__(240)(__webpack_require__(250))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = function() {};
	if (process.env.NODE_ENV !== 'production') {
	  debug = __webpack_require__(218)('sockjs-client:main');
	}
